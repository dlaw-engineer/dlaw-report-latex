...
จะมีการเขียนการทำงานอย่างเป็นลำดับขั้นตอนบาง Use case ที่มีความซับซ้อนออกมาซึ่งสามารถดูได้จากรูปที่ \ref{fig:sqCreateCase} - \ref{fig:sqChangePassword}
    ...
    \begin{figure}[!ht]\centering
        \includegraphics[width=13cm, trim={0 3cm 0 2cm},clip]{./assets/sequence-diagram/create-case.png}
        \caption{รูปแสดง Sequence diagram ของ Create case}\label{fig:sqCreateCase}
    \end{figure}

    \newpage
    \subsection{Archive case} 
    \begin{figure}[!ht]\centering
        \includegraphics[width=13cm, trim={0 4cm 0 3cm},clip]{./assets/sequence-diagram/archive-case.png}
        \caption{รูปแสดง Sequence diagram ของ Archive case}\label{fig:sqArchiveCase}
    \end{figure}

    \newpage
    \subsection{Delete case} 
    \begin{figure}[!ht]\centering
    ...
    \begin{figure}[!ht]\centering
        \includegraphics[width=15cm, trim={0 6cm 0 6cm},clip]{./assets/sequence-diagram/upload-file.png}
    ...
    \begin{figure}[!ht]\centering
        \includegraphics[width=13cm, trim={0 10cm 0 7cm},clip]{./assets/sequence-diagram/create-event.png}
