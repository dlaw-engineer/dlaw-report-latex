...
\def\thaidissadvisor{ผศ.ดร.ปริยกร ปุสวิโร}
...
\begin{itemize}
  ...
  \hspace*{1cm} ในขั้นตอนการจัดการเอกสารของทนายนั้น ทนายจะจัดเก็บไฟล์เอกสาร หรือโฟลเดอร์ไว้ในคอมพิวเตอร์ส่วนตัว และมีการตั้งชื่อโฟลเดอร์เป็นชื่อคนและต่อมาก็เปลี่ยนมาเป็นวันที่รับคดี แต่ก็ยังมีปัญหาในการค้นหาโฟลเดอร์คดีต่าง ๆ อยู่ดี โดยทนายก็จะมีการใช้ Google sheet ในการจัดเก็บรายการของเอกสารต่างๆ และถ้าหากทนายต้องการแชร์เอกสารให้ทนายคนอื่น ๆ ทางทนายที่เป็นเจ้าของคดีนั้นก็จะใช้ Dropbox ในการแชร์เอกสารให้กับทนายคนอื่น อีกทั้งถ้าหากศาลมีกำหนดการนัดหมาย หรือทนายต้องการจะนัดหมายลูกความ ทางทนายก็จะต้องสร้างกำหนดการ หรือสร้างนัดหมายขึ้นมาเองโดยใช้ Google calendar ทำให้บางนัดหมายสามารถตกหล่น หรือหลงลืมได้
  \item \textbf{ศูนย์ทนายความเพื่อสิทธิมนุษยชนหรือ หรือ TLHR} \\
  \hspace*{1cm} ระบบจัดการเอกสารหลัก ๆ ของทนายนั้นจะอยู่ที่ notion โดยทนายจะนำ notion มาใช้ในการจัดเก็บข้อมูลเอกสาร ชื่อเอกสาร รวมถึงนัดหมายและตารางงานของทนาย ซึ่ง notion นั้นไม่สามารถจัดเก็บเป็นไฟลืเอกสารได้ จึงมีความจำเป็นที่จะใช้ Google drive ในการจัดเก็บเอกสาร และจะมีผู้ช่วยที่จะมาคอย เปลี่ยนชื่อเอกสาร และจดบันทึกลงใน Notion เนื่องจากทนายนั้น ไม่มีเวลามากพอในการจดบันทึกที่อยู่ของเอกสาร 
\end{itemize}
\hspace*{1cm} จากรายละเอียดที่ได้กล่าวมาข้างต้นของทั้ง 2 องค์กร จะเห็นได้ว่ามีการใช้ Google drive และ Dropbox เป็นโปรแกรมหลักในการจัดการเก็บเอกสารอยู่ ซึ่งถ้าในกรณีที่ทำคดีจบสิ้นแล้วทนายก็จะนำไฟล์ของเอกสารต่าง ๆ ย้านไปยังอีกโฟลเดอร์หนึ่งหรืออาจจะต้องมีการลบโฟลเดอร์นั้นทิ้ง โดยทางเว็บแอปพลิเคชัน D-law ที่คณะผู้จัดทำกำลังจะพัฒนาขึ้นมานี้ จะมีระบบสำหรับ Archive ที่ใช้ในการจัดเก็บเอกสารที่ดำเนินการเสร็จสิ้น เพื่อที่จะได้ซ่อนเอกสารที่ไม่ได้ใช้ ให้เป็นระเบียบเรียบร้อยมากขึ้น และจะสามารถกลับมาค้นหาและย้อนดูได้ อีกทั้งยังมีระบบแท๊กที่ทำให้ค้นหาเอกสารตามชนิดของไฟล์ หรือตามชื่อเฉพาะที่ทนายตั้งขึ้นเองได้สะดวกยิ่งขึ้น และในส่วนของการนัดหมายกับลูกความหรือตารางงานทนายยังมีการใช้ Google calendar และ Notion ในการสร้างกำหนดการและนัดหมาย โดยทางเว็บแอปพลิเคชันของคณะผู้จัดทำนั้น จะมีระบบสำหรับการจัดการนัดหมายอยู่ภายในตัวซึ่งทำการเชื่อมต่อกับ Google calendar และสามารถส่ง Email ไปยังลูกความหรือทนายคนอื่น ๆ ที่เกี่ยวข้อง ทำให้สามารถลดเวลาในการนัดหมายในแต่ละครั้ง และเพิ่มความสะดวกในการนัดหมายได้อีกด้วย
...
\end{figure}
% \hspace*{1cm} ฟังก์ชันที่ใช้ในการแก้ไขชื่อโฟลเดอร์ ดังรูป \ref{fig:rename-folder} \\
\begin{figure}[!h]\centering
...
\end{figure}
% \hspace*{1cm} ฟังก์ชันที่ใช้ในการแก้ไขสิทธ์การเข้าถึงโฟลเดอร์ โดยจะออกแบบมาให้สามารถ เพิ่ม ลด ผู้ใช้งานที่จะสามารถเข้าถึงเอกสารในโฟลเดอร์นั้น ๆ ได้ ดังรูป \ref{fig:manage-folder-permission} \\
\begin{figure}[!h]\centering
  \includegraphics[width=8cm]{./assets/userinterface/manage-folder-permission.png}
  \caption{รูปแสดงการออกแบบหน้าแก้ไขสิทธ์การเข้าถึงโฟลเดอร์}\label{fig:manage-folder-permission}
\end{figure}
% \hspace*{1cm} ฟังก์ชันที่ใช้ในการจัดเก็บโฟลเดอร์ ดังรูป \ref{fig:archive-folder} \\
\begin{figure}[!h]\centering
  \includegraphics[width=8cm]{./assets/userinterface/archive-folder.png}
  \caption{รูปแสดงการออกแบบหน้าจัดเก็บโฟลเดอร์}\label{fig:archive-folder}
\end{figure}
% \hspace*{1cm} ฟังก์ชันที่ใช้ในการลบโฟลเดอร์ ดังรูป \ref{fig:delete-folder} \\
\begin{figure}[!h]\centering
  \includegraphics[width=8cm]{./assets/userinterface/delete-folder.png}
  \caption{รูปแสดงการออกแบบหน้าลบโฟลเดอร์}\label{fig:delete-folder}
\end{figure}

  \item \textbf{File component} \\
\hspace*{1cm} ถูกออกแบบมาให้ใช้สำหรับดูข้อมูลของไฟล์ โดยจะประกอบไปด้วยตารางแสดงข้อมูลไฟล์ และแสดงการใช้ฟังก์ชันต่าง ๆ เช่น ฟังก์ชันย้ายโฟลเดอร์ และฟังก์ชันเผยแพร่เอกสารเป็นต้น ดังรูป \ref{fig:file-component} - \ref{fig:delete-file} ดังนี้

\begin{figure}[!h]\centering
  \includegraphics[width=16cm]{./assets/userinterface/file-component.png}
