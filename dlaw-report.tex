...
\begin{itemize}
  ...
  \hspace*{1cm} %% TODO : เริ่มจากสิ่งที่เราคิดมาตอนแรก เป็นความจริง ทนายต้องจัดการกับคนเยอะ หาเอกสารยาก ใช้ windowในการหา เคยใช้ software แล้วแต่ใช้ยาก เพิ่มภาระเลยเลิกใช้
  \item \textbf{ศูนย์ทนายความเพื่อสิทธิมนุษยชนหรือ หรือ TLHR} \\
  \hspace*{1cm} %% TODO : ใช้ Notion และลูกค้าค่อนข้าง ห่วงเรื่อง privacy เพิ่มเติมโยงให้ pain point ของilaw และ tlhr เป็นอันเดียวกัน 
\end{itemize}
